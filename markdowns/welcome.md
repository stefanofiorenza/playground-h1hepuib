...
@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/main/java/com/knits/jbasic/labs/Labs01.java"], "command": "com.knits.jbasic.labs.test.Labs01Test#test"})
